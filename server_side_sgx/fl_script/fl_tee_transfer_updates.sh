...
SERVER_AVERAGED_DIR="./results/${DATASET}/averaged_transfer_updates/"
SERVER_UPDATES_DIR="./results/${DATASET}/client_updates_transfer_updates/"
...
do
	...
	cp ${STARTER_REE} "${SERVER_AVERAGED_DIR}${DM}_averaged_r${r}.weights_ree"
